...
public class HouseEntity
    implements Serializable, Comparable<HouseEntity>, Comparator<HouseEntity>
{
    ...
    public HouseEntity(CUSP_AND_PLANETS value, double position)
    {
        this(value, position, null);
    }

    public HouseEntity(CUSP_AND_PLANETS value, double position, String information)
    {
