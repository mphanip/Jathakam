...
import static mpp.jathakamu.Constants.SEC_IN_NANO_D;
    ...
    implements Serializable
{
            ...
            double secs, String sTimeZone)
    {
        ...
        double secsDiff = secs * SEC_IN_NANO_D - seconds * SEC_IN_NANO_D;
    ...
    {
        int[] timeParts = getTimeAttributes(time);
    ...
    public final int[] getTimeAttributes(double time)
    {
        int []timeAttrs = new int[4];
        
        timeAttrs[0] = Double.valueOf(time).intValue();
        double mins = (time - timeAttrs[0]) * 60D;
        timeAttrs[1] = Double.valueOf(mins).intValue();
        double secs = (mins - timeAttrs[1]) * 60D;
        timeAttrs[2] = Double.valueOf(secs).intValue();
        double secsDiff = secs * SEC_IN_NANO_D - timeAttrs[2] * SEC_IN_NANO_D;
        timeAttrs[3] = Double.valueOf(secsDiff).intValue(); 
