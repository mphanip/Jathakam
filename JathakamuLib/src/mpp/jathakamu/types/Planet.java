...
public enum Planet
{
    ...
    private final static List<Planet> VDPLANETS = new ArrayList<>();
    ...
    /**
     *
     * @return planet index as per swiss ephemeris, use this index to get planet
     * details
     */
    public int getIndex()
    {
    ...
    {
        if (VDPLANETS.isEmpty())
        {
            VDPLANETS.add(Planet.KETU);
            VDPLANETS.add(Planet.VENUS);
            VDPLANETS.add(Planet.SUN);
            VDPLANETS.add(Planet.MOON);
            VDPLANETS.add(Planet.MARS);
            VDPLANETS.add(Planet.RAHU);
            VDPLANETS.add(Planet.JUPITER);
            VDPLANETS.add(Planet.SATURN);
            VDPLANETS.add(Planet.MERCURY);
        }

    	List<Planet> pList = new ArrayList<>(VDPLANETS);
